package com.u2020.sdk.env.device.macaddress;
...
public class IWifiManagerUtil {
    ...
    static final String INVALID_ADDRESS = "02:00:00:00:00:00";

    public static String getMacAddress(Context context) {
        String address;
        if (!TextUtils.isEmpty(address = getMacAddressLevel1(context))
                && !INVALID_ADDRESS.contains(address)) {
            return address;
        }
        ...
        if (INVALID_ADDRESS.contains(address)) {
            address = "";
        }
        return address;
    }
